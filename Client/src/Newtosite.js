  ...
  return (
    <>
      ...
      <div style={{ fontSize: "6rem", color: "#0081cf" }}>
        <center>Are you a Customer?</center>
      </div>
        ...
        <div className="container px-5 pb-20  mx-auto flex flex-wrap">
          ...
          <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <path d="M12 22V8M5 12H2a10 10 0 0020 0h-3"></path>
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">
                  Get different room templates
                </h2>
                <p className="leading-relaxed">
                  After you successfully signed in, you can get variety of templates to customize the room layout.
                </p>
              </div>
            </div>
          </div>
          <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                ...
                <p className="leading-relaxed">
                  After designing your desired room layout you can save and use it for future assistance. 
                </p>
              </div>
            </div>
            <hr />
          ...
          <div className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                ...
                <p className="leading-relaxed">
                  Pay the amount through UPI or Debit cards to access the premium.
                </p>
              </div>
            </div>
          </div>
